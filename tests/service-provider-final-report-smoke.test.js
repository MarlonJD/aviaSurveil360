...
assert.match(html, /Review CAP closure evidence submitted by service providers/);
assert.match(html, /SkyCargo Air/);
assert.match(html, /Service Provider/);
assert.match(html, /All CAPs \(14\)/);
assert.match(html, /Pending My Verification \(3\)/);
assert.match(html, /Perimeter Fence Security/);
assert.match(html, /CAP Evidence Submitted/);
assert.match(html, /Verification Summary/);
assert.match(html, /My Verification Workload/);
