...
assert.equal((assignedAuditHeader[1].match(/<th/g) || []).length, 10);
assert.match(assignedAuditHeader[1], /Status<br><small>Progress<\/small>/);
assert.doesNotMatch(assignedAuditHeader[1], /<th>Progress/);
...
assert.match(html, /Airline XYZ Operator Audit Preliminary Report/);
