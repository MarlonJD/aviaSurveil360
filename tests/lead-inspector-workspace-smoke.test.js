...
assert.match(html, /126 Questions/);
...
assert.match(html, /Assign Checklist Questions/);
assert.match(html, /Checklist Items[\s\S]*126/);
assert.match(html, /Assigned[\s\S]*42/);
assert.match(html, /Unassigned[\s\S]*84/);
assert.match(html, /Inspectors[\s\S]*4/);
assert.match(html, /Ahmed Ali/);
assert.match(html, /Maria Silva/);
assert.match(html, /Is PBE serviceable and accessible/);
