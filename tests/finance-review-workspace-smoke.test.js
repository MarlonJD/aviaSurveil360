...
const financeSummary = html.match(/<section class="[^"]*mobile-decision-summary[^"]*"[\s\S]*?<\/section>/)[0];
assert.match(financeSummary, /Current owner/);
assert.match(financeSummary, /Next action/);
assert.match(financeSummary, /Target/);
assert.match(financeSummary, /Status/);
assert.match(financeSummary, /<button/);
