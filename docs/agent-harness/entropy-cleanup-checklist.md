...
| Active plan index matches actual harness status. | ready-for-verification | Plan owner / future agents | `../plans/index.md` row for harness readiness. |
...
- `../plans/index.md` keeps an old next todo after implementation evidence
  changes.
...
- Keep durable blockers and accepted risks in `../plans/notes/` when they must
  survive the current plan.
