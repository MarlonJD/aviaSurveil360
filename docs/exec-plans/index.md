...
| [Department And General Manager Oversight Workspaces](active/2026-07-09-department-manager-workspaces-plan.md) | active | Tasks 1-7 are committed and pushed; Task 8 Department Manager Risk Dashboard is verified locally and prepared for its task-scoped commit. **Next:** commit and push Task 8, then write the Task 9 General Manager workspace smoke test and verify RED. |
