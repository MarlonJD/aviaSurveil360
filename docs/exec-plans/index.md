...
| [Department And General Manager Oversight Workspaces](active/2026-07-09-department-manager-workspaces-plan.md) | active | Tasks 1-6 are verified locally; Tasks 1-5 are committed and pushed, and Task 6 CAP Monitoring is prepared as its focused commit. **Next:** write the Task 7 Checklist Management smoke test and verify RED. |
