...
| [Responsive QA Remediation](active/2026-07-08-responsive-qa-remediation-plan.md) | active | QA findings inventory and remediation plan created after 2026-07-08 responsive review. **Next:** execute Task 1 by capturing the full route/viewport baseline evidence, then implement the Inspector Findings/CAP IA and responsive layout fixes. |
