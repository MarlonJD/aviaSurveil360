...
export AVIA_TEST_DATABASE_URL="postgres://aviasurveil:aviasurveil@127.0.0.1:${TASK_POSTGRES_PORT}/aviasurveil?sslmode=disable"
export AVIA_TEST_OIDC_ISSUER_URL="http://127.0.0.1:${TASK_KEYCLOAK_PORT}/realms/aviasurveil360"
